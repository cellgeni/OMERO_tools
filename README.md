...
**!! IMPORTANT - for Xenium please use ann2Xenium_coord.py as it is the most updated one and has an option of pulling actual coordinates of ROIs in json file !!**
